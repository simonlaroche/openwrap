...
{
    class package_with_versioned_depenency_found : contexts.preloader
    {
        public package_with_versioned_depenency_found()
        {
            given_project_directory();
            given_project_package("bootstrap", "1.0.0", "depends: bootstrap-core = 1.0");
            given_project_package("bootstrap-core", "1.0.0");
            given_project_package("bootstrap-core", "2.0.0");
