...
namespace Tests.contexts
{
    abstract class package_graph_visitor : context
    {
        ...
        public void given_package(string name, string version, params string[] dependencies)
        {
            ...
            Packages.Add(package = new InMemoryPackage() { Name = name, SemanticVersion = version.ToSemVer(), Dependencies = dependencies.Select(DependsParser.ParseDependsValue).ToList() });
