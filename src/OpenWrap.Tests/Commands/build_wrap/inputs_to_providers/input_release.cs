...
{
    public class input_release : contexts.build_wrap
    {
        public input_release()
        {
            ...
            when_executing_command("-release");
        }

        [Test]
        public void configuration_is_not_set()
        {
            PackageBuilderWithConfig.ConfigurationValue.ShouldBe("Release");
        }
    }
}