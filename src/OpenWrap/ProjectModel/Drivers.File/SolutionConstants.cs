    ...
    public static class SolutionConstants
    {
        ...
        static SolutionConstants()
        {
            Editions =new Dictionary<Version, string>
            {
                ...
                { VisualStudio2012Version, "Visual Studio 2012" },
            };
        }
        ...
        public static readonly Version VisualStudio2012Version = new Version(12, 0);

        public const string ADD_IN_PROGID_2012 = "OpenWrap.VisualStudio2012";
